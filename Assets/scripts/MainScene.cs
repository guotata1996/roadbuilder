...
public class MainScene : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        drawing.roadManager.addRoad(new Arc(P1, P0, Mathf.PI/2), nofencecfg3);
        drawing.roadManager.addRoad(new Line(P2, P3), nofencecfg2);
        drawing.roadManager.addRoad(new Arc(P4, P3, Mathf.PI / 2), nofencecfg3);
        drawing.roadManager.addRoad(new Line(P5, P6), nofencecfg2);
        drawing.roadManager.addRoad(new Arc(P7, P6, Mathf.PI / 2), nofencecfg3);
        drawing.roadManager.addRoad(new Line(P8, P9), nofencecfg2);
        drawing.roadManager.addRoad(new Arc(P10, P9, Mathf.PI / 2), nofencecfg3);
        drawing.roadManager.addRoad(new Line(P11, P0), nofencecfg2);
        ...
        drawing.roadManager.addRoad(new Line(P12, P13), fencecfg);
        drawing.roadManager.addRoad(new Line(P13, P14), fencecfg);
        drawing.roadManager.addRoad(new Line(P14, P15), fencecfg);
        ...
        drawing.roadManager.addRoad(new Line(P16, P17), fencecfg);
        drawing.roadManager.addRoad(new Line(P17, P18), fencecfg);
        drawing.roadManager.addRoad(new Line(P18, P19), fencecfg);
        ...
        drawing.roadManager.addRoad(new Line(P20, P12), nofencecfg3);
        drawing.roadManager.addRoad(new Line(P15, P21), nofencecfg3);
        drawing.roadManager.addRoad(new Line(P22, P16), nofencecfg3);
        drawing.roadManager.addRoad(new Line(P19, P23), nofencecfg3);
        ...
        drawing.roadManager.addRoad(new Line(P24, P25), doubledircfg);
        drawing.roadManager.addRoad(new Line(P26, P27), doubledircfg);

        drawing.roadManager.addRoad(new Bezeir(P11, new Vector2(20f, 60f), Algebra.toVector2(P15)), singleLane);
        drawing.roadManager.addRoad(new Bezeir(Algebra.toVector2(P16), new Vector2(-20f, 60f), P0), singleLane);
        drawing.roadManager.addRoad(new Bezeir(Algebra.toVector2(P12), new Vector2(20f, -60f), P6), singleLane);
        drawing.roadManager.addRoad(new Bezeir(P5, new Vector2(-20f, -60f), Algebra.toVector2(P19)), singleLane);

        drawing.roadManager.addRoad(new Line(P24, P9), singleLane);
        drawing.roadManager.addRoad(new Line(P8, P24), singleLane);
        drawing.roadManager.addRoad(new Line(P2, P26), singleLane);
        drawing.roadManager.addRoad(new Line(P26, P3), singleLane);
        ...
        drawing.roadManager.addRoad(new Bezeir(P28, PCT1, P29), doubledirfencecfg);
